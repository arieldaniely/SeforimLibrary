...
tasks.register("packageBookImporterWindowsPortable") {
    group = "application"
    description = "Package the desktop book importer as a portable Windows ZIP (run on Windows)."
    dependsOn(":bookimporter:packageWindowsPortable")
}
